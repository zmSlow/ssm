...
<div id="userAdd" class="easyui-window" title="新增会员"
     data-options="modal:true,closed:true,iconCls:'icon-save',href:'/user/page/user-add',onBeforeClose:onBeforeClose"
...
<script type="text/javascript">
    ...
    var toolbar = [{
        ...
        handler: function () {
            ...
            rowData.birthday=formatBirthday(rowData.birthday,null);
            $('#userAdd').window('open');
